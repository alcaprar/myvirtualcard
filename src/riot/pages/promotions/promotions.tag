<promotions>
    <div class="page-wrapper" id="{opts.riotid}" style="display: none;">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Promotions management</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
        <div class="row">
            <div class="col-lg-3">
                <button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#addPromotionModal">
                    Add promotion
                </button>
            </div>
        </div>
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                <tr each="{ promotion, key in promotions}">
                                    <td>{key+1}</td>
        ...
        <div class="modal fade" id="addPromotionModal" tabindex="-1" role="dialog" aria-labelledby="addPromotionModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        <h4 class="modal-title" id="addPromotionModalLabel">Modal title</h4>
                    </div>
                    <div class="modal-body">
                        <form role="form">
                            <input id="promotionId" name="promotionId" type="text" style="display: none" value="">
                            <div class="form-group">
                                <label>Promotion name</label>
                                <input class="form-control" name="name" id="promotionName" placeholder="Promotion name">
                            </div>
                            <div class="form-group">
                                <label>Points needed by the user to activate the promotion</label>
                                <input class="form-control" name="points" id="promotionPoints" placeholder="Points needed">
                            </div>
                            <div class="form-group">
                                <label>Starting date. (Leave it blank if you don't want automated promotions.)</label>
                                <input class="form-control" name="startingDate" id="promotionStartingDate" placeholder="Starting date">
                            </div>
                            <div class="form-group">
                                <label>Stopping date. (Leave it blank if you don't want automated promotions.)</label>
                                <input class="form-control" name="stoppingDate" id="promotionStoppingDate" placeholder="Stopping date">
                            </div>
                            <div class="form-group">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="active" id="promotionActive" value="1" checked>Active
                                    </label>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" onclick="{createPromotion}">Save changes</button>
                    </div>
                </div>
                <!-- /.modal-content -->
            </div>
