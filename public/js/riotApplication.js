...
riot.tag2('userslist', '<div class="page-wrapper" id="{opts.riotid}" style="display: none;"> <div class="row"> <div class="col-lg-12"> <h1 class="page-header">Users list</h1> </div> </div> <div class="row"></div> </div>', '', '', function(opts) {
});
